...
export default {
    ...
    'menu.user.list': 'User Center List',
    'menu.role': 'User Role',
    'menu.role.list': 'User Role List',
    'menu.atlas': 'Atlas',
    'menu.material': 'Material Manage',
    'menu.material.list': 'Collection List',
    'menu.website': 'Blog',
    'menu.setting': 'Website Setting',
    'menu.faq': 'FAQ',
    'navbar.docs': 'Docs',
    ...
    'menu.material.tag': 'Material Tag',
